...
Точные значения $\alpha$ и $\beta$ по выборке найти нельзя — их можно только оценить; оценки обозначают $a$ и $b$, оценённое уравнение записывается как $\hat{y} = a + bx$. Формальный разбор оценок, метода наименьших квадратов и условий, при которых модели можно доверять, — в [лекции 2](02-mnk-teorema-gaussa-markova.md).
