...
Лекция закончилась на предпосылках ступени I. Оставшаяся часть презентации (слайды 41–130) — материал следующих занятий:

<details>
<summary>Темы слайдов 41–130</summary>

- **Ступень I, продолжение:** регламентация проектной деятельности и деятельности самого проектного офиса, внедрение ИСУП; принципы и процессы управления проектами (инициация, планирование, исполнение, контроль); порядок разработки, структура и содержание регламентов; фаза, веха и жизненный цикл проекта; заинтересованные стороны; структура проектного офиса и требования к квалификации сотрудников (в том числе PMP).
- **Ступень II. Расширение влияния:** пул ресурсов и его формирование, компетенции, взаимодействие проектного офиса с функциональными подразделениями при планировании ресурсов, управление стратегическими ресурсами, PERT-оценка, снижение кадровых рисков.
- **Ступень III. Накопление и передача опыта:** аудит проектной деятельности, управление знаниями и база знаний, критерии успешности проектов, антикризисное управление проектами, оценка трудоёмкости и стоимости типовых работ, инструменты контроля, управление личным временем руководителя.
- **Ступень IV. Стратегическое управление портфелем:** определения портфеля и портфельного управления, критерии отбора проектов, показатели эффективности (рентабельность, NPV, IRR, дисконтированный срок окупаемости, индексы доходности), анализ отклонений, ИСУПП, варианты формирования портфеля, жизненный цикл портфеля, роли руководителя и аналитика портфеля, балансировка портфеля.
- **Оценка деятельности проектного офиса:** критерии и параметры эффективности, карта эффективности по ступеням.
